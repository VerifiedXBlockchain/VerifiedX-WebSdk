...
describe('Keypairs', () => {
  ...
  test('mnumonic generates correct address', () => {
    const data = keypairService.keypairFromMnemonic(
  ...
  test('can sign message', () => {
    ...
    const expectedSig =
      '304402204e2284ccd24fbf44df54674a39c22ee9f4f10acc1e772c3c7eeea9b6f0e9c61e022024aa768aefb87a1c03408d31a3ce81b18ead75ee33e1c0213011f9ca3c806bf7.03dac7c36f74befdf45035315f6f733f3eeee1f9bab55303dd1db7f6914f8cc64c';
